...
class Telegram
{
     ...
     */
    public function respondSuccess(): bool|string
    {
     ...
     * \return the JSON usersModel's message.
     */
    ...
    /**
     * \return the String usersModel's text.
     */
    ...
    /**
     * \return the String usersModel's chat_id.
     */
    ...
    {
        return $this->data['message']['photo'][0];
    }
    ...
    {
        if (@$this->data['message']['entities'][0]['type'] == "bot_command") {
            return true;
        } else {
            return false;
        }
     ...
     * \param $selective Boolean Use this parameter if you want to show the keyboard to specific usersModel only. Targets: 1) usersModel that are @mentioned in the text of the Message object; 2) if the bot's message is a reply (has reply_to_message_id), sender of the original message.
     ...
     */
    public function buildInlineKeyboardButton($text, $callback_data = '', $url = '', $switch_inline_query = null, $switch_inline_query_current_chat = null, $callback_game = '', $pay = '')
    {
        $replyMarkup = [
            'text' => $text,
        ];
     ...
     * @return bool|string
     */
    public function getUpdateType(): bool|string
    {
        $update = $this->data;
